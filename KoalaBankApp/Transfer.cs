...
public class Transfer
{
    ...
    public void transferMenu(List<BankAccount> accountsTransfer, User activeUser, List<User> accounts, List<Transactions> activeTransaction, CurrencyRates rates)
    {
        ...
        do
        {
            ...
            {
                case 1:
                    TransferMoney(accountsTransfer, activeUser, activeTransaction, 100);
                    break;
                case 2:
    ...
    public void TransferMoney(List<BankAccount> accountsTransfer, User activeUser, List<Transactions> activeTransaction, double testAmountToTransfer)
    {
